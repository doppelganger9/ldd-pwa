...
alias git_up='git fetch --all -p && git pull --rebase --autostash'
# will reset all changes and remove all untracked files and directories recursively
alias git_undo_all='git reset --hard && git clean -f -d'
